...
<body> 
    <div class="confirmation-card">
        <div class="image-card">
            <img src="images/wedding/w8.jpg" alt="Wedding 9">
        </div>
        <div class="details-card">
            ...
            <div class="order-card">
                <form action="place_order.php" method="POST" onsubmit="updateHiddenInput('payment_method9', 'hidden_payment_method9')">
                    <input type="hidden" name="product_name" value="Wedding 9">
                    <input type="hidden" name="product_price" value="3000">
                    <input type="hidden" name="product_image" value="images/wedding/w8.jpg">
                    <div class="size-card">
                    ...
                    <input type="number" id="quantity9" name="quantity" value="1" min="1" max="10" class="quantity" onchange="calculateTotal(3000, this.value, 'total9')">
                    <br>
                    <span>Total: $<span id="total9" class="total">3000.00</span></span>
                    <div class="payment-method">
                        <label for="payment_method9">Select Payment Method:</label>
                        <select id="payment_method9" name="payment_method" onchange="updateHiddenInput('payment_method9', 'hidden_payment_method9')">
                    ...
                    <input type="hidden" id="hidden_payment_method9" name="hidden_payment_method">
