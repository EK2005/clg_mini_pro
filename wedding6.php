...
<div class="confirmation-card">
    <div class="image-card">
        <img src="images/wedding/w6.jpg" alt="Wedding 6">
    </div>
    <div class="details-card">
        ...
        <div class="description-card">
            <p>Product Details:
                <br>Name: Wedding Dress
                <br>Fabric: Silk
                <br>Sleeve Length: Full Sleeve
        ...
        <div class="order-card">
            <form action="place_order.php" method="POST" onsubmit="updateHiddenInput('payment_method6', 'hidden_payment_method6')">
                <input type="hidden" name="product_name" value="Wedding 6">
                <input type="hidden" name="product_price" value="3500">
                <input type="hidden" name="product_image" value="images/wedding/w6.jpg">
                <div class="size-card">
                ...
                <input type="number" id="quantity6" name="quantity" value="1" min="1" max="10" class="quantity" onchange="calculateTotal(3500, this.value, 'total6')">
                <br>
                <span>Total: $<span id="total6" class="total">3500.00</span></span>
                <div class="payment-method">
                    <label for="payment_method6">Select Payment Method:</label>
                    <select id="payment_method6" name="payment_method" onchange="updateHiddenInput('payment_method6', 'hidden_payment_method6')">
                ...
                <input type="hidden" id="hidden_payment_method6" name="hidden_payment_method">
