...
<div class="confirmation-card">
    <div class="image-card">
        <img src="images/wedding/w1.jpg" alt="Wedding 1">
    </div>
    <div class="details-card">
        <div class="title-price-card">
            <h3>Wedding Wear 1</h3>
            <p>Price: Rs.3000</p>
        </div>
        ...
        <div class="order-card">
            <form action="place_order.php" method="POST" onsubmit="updateHiddenInput('payment_method_w1', 'hidden_payment_method_w1')">
                <input type="hidden" name="product_name" value="Wedding Wear 1">
                <input type="hidden" name="product_price" value="3000">
                <input type="hidden" name="product_image" value="images/wedding/w1.jpg">
                <div class="size-card">
                ...
                <label for="quantity_w1">Quantity:</label>
                <input type="number" id="quantity_w1" name="quantity" value="1" min="1" max="10" class="quantity" onchange="calculateTotal(3000, this.value, 'total_w1')">
                <br>
                <span>Total: Rs. <span id="total_w1" class="total">3000.00</span></span>
                <div class="payment-method">
                    <label for="payment_method_w1">Select Payment Method:</label>
                    <select id="payment_method_w1" name="payment_method" onchange="updateHiddenInput('payment_method_w1', 'hidden_payment_method_w1')">
                ...
                <input type="hidden" id="hidden_payment_method_w1" name="hidden_payment_method">
