...
<body>
    <div class="confirmation-card">
        <div class="image-card">
            <img src="images/wedding/w5.jpg" alt="Wedding 5">
        </div>
        <div class="details-card">
            <div class="title-price-card">
                <h3>Wedding Dress 5</h3>
                <p>Price: $3500</p>
            </div>
            ...
            <div class="order-card">
                <form action="place_order.php" method="POST">
                    <input type="hidden" name="product_name" value="Wedding Dress 5">
                    ...
                    <input type="number" id="quantity5" name="quantity" value="1" min="1" max="10" class="quantity">
                    <br>
                    <span>Total: $<span id="total5" class="total">3500.00</span></span>
                    <div class="payment-method">
                        <label for="payment_method5">Select Payment Method:</label>
                        <select id="payment_method5" name="payment_method">
                            <option value="credit_card">Credit Card</option>
                            <option value="debit_card">Debit Card</option>
                            <option value="paypal">PayPal</option>
                            <option value="cash_on_delivery">Cash on
