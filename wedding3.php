...
<div class="confirmation-card">
    <div class="image-card">
        <img src="images/wedding/w3.jpg" alt="wedding 3">
    </div>
    <div class="details-card">
        ...
        <div class="order-card">
            <form action="place_order.php" method="POST" onsubmit="updateHiddenInput('payment_method3', 'hidden_payment_method3')">
                <input type="hidden" name="product_name" value="Wedding Dress 3">
                <input type="hidden" name="product_price" value="3500">
                <input type="hidden" name="product_image" value="images/wedding/w3.jpg">
                <div class="size-card">
                ...
                <input type="number" id="quantity3" name="quantity" value="1" min="1" max="10" class="quantity" onchange="calculateTotal(3500, this.value, 'total3')">
                <br>
                <span>Total: $<span id="total3" class="total">3500.00</span></span>
                <div class="payment-method">
                    <label for="payment_method3">Select Payment Method:</label>
                    <select id="payment_method3" name="payment_method" onchange="updateHiddenInput('payment_method3', 'hidden_payment_method3')">
                ...
                <input type="hidden" id="hidden_payment_method3" name="hidden_payment_method">
