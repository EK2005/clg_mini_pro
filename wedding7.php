...
<body> 
    <div class="confirmation-card">
        <div class="image-card">
            <img src="images/wedding/w7.jpg" alt="Wedding 7">
        </div>
        <div class="details-card">
            ...
            <div class="order-card">
                <form action="place_order.php" method="POST" onsubmit="updateHiddenInput('payment_method7', 'hidden_payment_method7')">
                    <input type="hidden" name="product_name" value="Wedding 7">
                    <input type="hidden" name="product_price" value="3500">
                    <input type="hidden" name="product_image" value="images/wedding/w7.jpg">
                    <div class="size-card">
                    ...
                    <input type="number" id="quantity7" name="quantity" value="1" min="1" max="10" class="quantity" onchange="calculateTotal(3500, this.value, 'total7')">
                    <br>
                    <span>Total: $<span id="total7" class="total">3500.00</span></span>
                    <div class="payment-method">
                        <label for="payment_method7">Select Payment Method:</label>
                        <select id="payment_method7" name="payment_method" onchange="updateHiddenInput('payment_method7', 'hidden_payment_method7')">
                    ...
                    <input type="hidden" id="hidden_payment_method7" name="hidden_payment_method">
