...
<body>
    <div class="confirmation-card">
        <div class="image-card">
            <img src="images/wedding/w5.jpg" alt="Wedding 8">
        </div>
        <div class="details-card">
            ...
            <div class="order-card">
                <form action="place_order.php" method="POST" onsubmit="updateHiddenInput('payment_method8', 'hidden_payment_method8')">
                    <input type="hidden" name="product_name" value="Wedding 8">
                    <input type="hidden" name="product_price" value="4500">
                    <input type="hidden" name="product_image" value="images/wedding/w5.jpg">
                    <div class="size-card">
                    ...
                    <input type="number" id="quantity8" name="quantity" value="1" min="1" max="10" class="quantity" onchange="calculateTotal(4500, this.value, 'total8')">
                    <br>
                    <span>Total: $<span id="total8" class="total">4500.00</span></span>
                    <div class="payment-method">
                        <label for="payment_method8">Select Payment Method:</label>
                        <select id="payment_method8" name="payment_method" onchange="updateHiddenInput('payment_method8', 'hidden_payment_method8')">
                    ...
                    <input type="hidden" id="hidden_payment_method8" name="hidden_payment_method">
