...
<body> 
    ...
    <div class="confirmation-card">
        <div class="image-card">
            <img src="images/wedding/w4.webp" alt="Wedding 4">
        </div>
        <div class="details-card">
            ...
            <div class="order-card">
                <form action="place_order.php" method="POST">
                    <input type="hidden" name="product_name" value="Wedding Dress 4">
                    <input type="hidden" name="product_price" value="2500">
                    <input type="hidden" name="product_image" value="images/wedding/w4.webp">
                    <div class="size-card">
                    ...
                    <input type="number" id="quantity4" name="quantity" value="1" min="1" max="10" class="quantity">
                    <br>
                    <span>Total: $<span id="total4" class="total">2500.00</span></span>
                    <div class="payment-method">
                        <label for="payment_method4">Select Payment Method:</label>
                        <select id="payment_method4" name="payment_method">
